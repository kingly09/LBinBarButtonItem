#
#  Be sure to run `pod spec lint LBinBarButtonItem.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #s.screenshots  = "https://github.com/kingly09/LBinBarButtonItem/blob/master/btn.gif"
  ...
  s.author             = { "kingly" => "362108564@qq.com" }
  # Or just: s.author    = "kingly"
  # s.authors            = { "kingly" => "362108564@qq.com" }
